...
File Name : SkyboxGameObject.h
Description : SkyboxGameObject class represents a skybox in the 3D scene, handling its creation, updating, and shader uniform data.
Author : Theo Morris
 ...
 */
class SkyboxGameObject : public GraphicsGameObject
{
public:
    /**
