...
namespace Shader
{
	extern sce::Agc::Shader	*sprite_utility_fill_p;
	extern sce::Agc::Shader	*sprite_utility_3d_fill_p;
}
...
namespace SpriteUtil {
	...
	extern sce::Agc::Toolkit::Result	g_result;

	/*!
	 * @~English
	 * @brief Initialize SpriteUtil
	 * @param videoMemory Allocator of VideoMemory
	 * 
	 * @retval SCE_OK Success
	 * @details This function does to initialize shader and to allocate required vertex/index buffers.
	 * @~Japanese
	 ...
	 */
	int	initialize(sce::SampleUtil::Graphics::VideoAllocator	&videoMemory);

	/*!
	 * @~English
	 * @brief Finalize SpriteUtil
	 * 
	 * @retval SCE_OK Success
	 * @details Release resources allocated by initialization function.
	 * @~Japanese
	 ...
	 * @param fillPs Specify a PixelShader, If you will replace a default PixelShader
	 * @param fillUserData Specify shader parameter of fillPs
	 *
	 ...
	 * @param depth デプス値
	 * @param fillPs デフォルトのピクセルシェーダを置き換える場合は、ピクセルシェーダ指定します
	 * @param fillUserData fillPsのシェーダパラメータ
	 * 
	 * @return sce::Agc::Toolkit::Result
	 * @details 四角形を描画します。四角形は指定された色により塗りつぶされます。 
	 */
	sce::Agc::Toolkit::Result	fillRect(
		...
		float	depth = 0.f,
		sce::Agc::Shader	*fillPs = 	::Shader::sprite_utility_fill_p,
		void	*fillUserData = nullptr
	);
	/*!
	 * @~English
	 * @brief Draws a square 
		...
		float	depth = 0.f)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillRect(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, rgba, depth);
		return g_result.m_errorCode;
	}
	 ...
	 * @param rgba Color of a square (Specifies RGBA)
	 * @param depth Depth value
	 * @param eighthWidth Line width(unit: 1/8 pixel)
	 *
	 * @return sce::Agc::Toolkit::Result
	 ...
	 * @param rgba 四角形の色（RGBAを指定）
	 * @param depth デプス値
	 * @param eighthWidth 線分の幅(単位:1/8ピクセル)
	 * 
	 * @return sce::Agc::Toolkit::Result
	 * @details 四角形を描画します。 
	 */
	sce::Agc::Toolkit::Result	drawRect(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		uint32_t	eighthWidth = 8)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawRect(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, rgba, depth, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result	fillOval(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		float	depth = 0.f)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillOval(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, rgba, depth);
		return g_result.m_errorCode;
	}
	 ...
	 * @details 楕円を描画します。 
	 */
	sce::Agc::Toolkit::Result	drawOval(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		uint32_t	eighthWidth = 1)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawOval(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, rgba, depth, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 * @details 線分を描画します。 
	 */
	sce::Agc::Toolkit::Result	drawLine(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		...
		uint32_t	eighthWidth = 1)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawLine(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, begin, end, rgba, depth, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 * @details テクスチャを描画します。 
	 */
	sce::Agc::Toolkit::Result	drawTexture(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		const sce::Agc::Core::Sampler	&sampler,
		...
		)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTexture(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, textureOffset, sizeInTexture, texture, sampler, colorCoeff, depth);
		return g_result.m_errorCode;
	}
	 ...
	 * @details テクスチャを描画します。 
	 */
	inline sce::Agc::Toolkit::Result	drawTexture(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		float	depth = 0.0f)
	{
		return drawTexture(dcb, sb, restoreCxState, position, size, sce::Vectormath::Simd::Aos::Vector2(0.f), sce::Vectormath::Simd::Aos::Vector2(1.f), texture, sampler, colorCoeff, depth);
	}
		...
		float	depth = 0.0f)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTexture(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, texture, sampler, colorCoeff, depth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result	drawTextureYuy2(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTextureYuy2(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, textureOffset, sizeInTexture, texture, sampler, colorCoeff, depth);
		return g_result.m_errorCode;
	}
	 ...
	 * @details テクスチャのRGBAの要素を、YUY2フォーマットのYUYVとみなし、 RGBに変換して描画します。Aには1.0fが設定されます。 
	 */
	inline sce::Agc::Toolkit::Result	drawTextureYuy2(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		float	depth = 0.f)
	{
		return drawTextureYuy2(dcb, sb, restoreCxState, position, size, sce::Vectormath::Simd::Aos::Vector2(0.f), sce::Vectormath::Simd::Aos::Vector2(1.f), texture, sampler, colorCoeff, depth);
	}
		...
		float	depth = 0.f)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTextureYuy2(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, texture, sampler, colorCoeff, depth);
		return g_result.m_errorCode;
	}
	 ...
	 * @param colorCoeff Color coefficient of a texture (Specifies RGBA)
	 * @param depth Depth value
	 * @param yuvMode YUV conversion mode
	 * @param bitDepth Bitdepth of YUV
	 * @param isClampToLastTexel Avoid sampling of texels out side of specified offset and size in the texture
	 * 
	 * @return sce::Agc::Toolkit::Result
	 ...
	 * @param isClampToLastTexel 指定したテクスチャ内オフセット、サイズ外のテクセルをサンプリングしない
	 * 
	 * @return sce::Agc::Toolkit::Result
	 * @details 最初のテクスチャのRの要素をYとみなし、２番めのテクスチャのRG要素をCbCrとみなし、シェーダー内でRGBフォーマットに変換して描画します。 Aには1.0fが設定されます。 
	 */
	sce::Agc::Toolkit::Result	drawTextureYcbcr(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		sce::Vectormath::Simd::Aos::Vector2_arg	textureOffset,
		sce::Vectormath::Simd::Aos::Vector2_arg	sizeInTexture,
		const sce::Agc::Core::Texture	&yTexture,
		const sce::Agc::Core::Sampler	&ySampler,
		const sce::Agc::Core::Texture	&cbcrTexture,
		const sce::Agc::Core::Sampler	&cbcrSampler,
		sce::Vectormath::Simd::Aos::Vector4_arg	colorCoeff = sce::Vectormath::Simd::Aos::Vector4(1.f),
		float	depth = 0.0f,
		YuvMode	yuvMode = YuvMode::kBt709,
		uint8_t	bitDepth  = 8,
		bool isClampToLastTexel = false
		);
	/*!
	 * @~English
	 * @brief Draws a texture in YCbCr format 
		...
		)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTextureYcbcr(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, textureOffset, sizeInTexture, yTexture, ySampler, cbcrTexture, cbcrSampler, colorCoeff, depth, yuvMode, bitDepth, isClampToLastTexel);
		return g_result.m_errorCode;
	}
	 ...
	 * @details 最初のテクスチャのRの要素をYとみなし、２番めのテクスチャのRG要素をCbCrとみなし、シェーダー内でRGBフォーマットに変換して描画します。 Aには1.0fが設定されます。 
	 */
	inline sce::Agc::Toolkit::Result	drawTextureYcbcr(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Vector2_arg	position,
		...
		bool isClampToLastTexel = false)
	{
		return drawTextureYcbcr(dcb, sb, restoreCxState, position, size, sce::Vectormath::Simd::Aos::Vector2(0.f), sce::Vectormath::Simd::Aos::Vector2(1.f), yTexture, ySampler, cbcrTexture, cbcrSampler, colorCoeff, depth, yuvMode, bitDepth, isClampToLastTexel);
	}
	/*!
	 * @~English
	 * @brief Draws a texture in YCbCr format 
		...
		bool isClampToLastTexel = false)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawTextureYcbcr(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, position, size, yTexture, ySampler, cbcrTexture, cbcrSampler, colorCoeff, depth, yuvMode, bitDepth, isClampToLastTexel);
		return g_result.m_errorCode;
	}
	 ...
	 * @details 点を描画します。 
	 */
	sce::Agc::Toolkit::Result	drawPoints(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		float psize,
		const sce::Agc::Core::Texture	&texture,
		const sce::Agc::Core::Sampler	&sampler,
		const sce::Agc::Core::Buffer	&vertices,
		...
		)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawPoints(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, psize, texture, sampler, vertices, indices, numIndices, colorCoeff, depth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result fillCube(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		...
		float ambient,
		float shininess,
		sce::Agc::Shader	*fillPs = ::Shader::sprite_utility_3d_fill_p,
		void	*fillUserData = nullptr);
		...
		float shininess)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillCube(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, lightPosition, color, ambient, shininess);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result drawCube(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		uint32_t lineWidth)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawCube(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, color, lineWidth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result fillSphere(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		float shininess)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillSphere(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, lightPosition, color, ambient, shininess);
		return g_result.m_errorCode;
	}
	 ...
	 * @param projection 射影行列
	 * @param color 色
	 * @param eighthWidth 線の太さ(単位: 1/8ピクセル)
	 * 
	 * @return sce::Agc::Toolkit::Result
	 * @details 3D空間にワイヤフレームの球を描画します。元の球は中心が原点、直径が１の球です。 
	 */
	sce::Agc::Toolkit::Result drawSphere(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		uint32_t eighthWidth)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawSphere(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, color, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result fillCylinder(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		float shininess)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillCylinder(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, lightPosition, color, ambient, shininess);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result drawCylinder(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		uint32_t eighthWidth)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawCylinder(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, color, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result fillCone(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		float shininess)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = fillCone(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, lightPosition, color, ambient, shininess);
		return g_result.m_errorCode;
	}
	 ...
	 */
	sce::Agc::Toolkit::Result drawCone(
		sce::Agc::DrawCommandBuffer	*dcb,
		sce::Agc::Core::StateBuffer *sb,
		sce::Agc::Toolkit::RestoreCxState restoreCxState,
		sce::Vectormath::Simd::Aos::Matrix4_arg model,
		...
		uint32_t eighthWidth)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawCone(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, model, view, projection, color, eighthWidth);
		return g_result.m_errorCode;
	}
		...
		uint32_t eighthWidth)
	{
		sce::Agc::Core::StateBuffer sb;
		sb.init(256, dcb, dcb);
		g_result = drawLine(dcb, &sb, sce::Agc::Toolkit::RestoreCxState::kEnable, view, projection, begin, end, color, eighthWidth);
		return g_result.m_errorCode;
	}
	 ...
	 * @param selfAllocatedModelsBuffer Specifiy whether 'models' buffer is allocated by user. If Specify 'false', 'models' will be copied in internally.
	 *
	 * @return sce::Agc::Toolkit::Result
	 * @details This draws a texture. 
	 * @~Japanese
	 ...
	 * @param selfAllocatedModelsBuffer 'models'に指定したメモリがユーザによって確保されたメモリであるかどうかを指定する。「false」が指定された場合は、内部で'models'データのコピーが行われる
	 * 
	 * 
	 * @return sce::Agc::Toolkit::Result
	 * @details テクスチャを描画します。 
	...
	sce::Agc::Toolkit::Result	renderQuads(
		...
		bool selfAllocatedModelsBuffer = false
	);
...
} } } // namespace sce::SampleUtilGraphics
