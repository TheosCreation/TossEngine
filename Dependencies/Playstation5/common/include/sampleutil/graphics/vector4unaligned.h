...
struct Vector4Unaligned
{
	...
	float z;
	float w;
	Vector4Unaligned &operator=(const sce::Vectormath::Simd::Aos::Vector4_arg &rhs)
	{
...
inline Vector4Unaligned ToVector4Unaligned(const sce::Vectormath::Simd::Aos::Vector4_arg &r)
{
	const Vector4Unaligned result = { r.getX(), r.getY(), r.getZ(), r.getW() };
	return result;
}

inline Vector3Unaligned ToVector3Unaligned(const sce::Vectormath::Simd::Aos::Vector4_arg &r)
{
