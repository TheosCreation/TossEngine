...
namespace ImGui
{
	...
	// Set Title or Placeholder string for Dialog
	IMGUI_API void			SetInputTextTitle(const ImWchar *title, ImGuiID id);
	IMGUI_API void			SetInputTextTitle(const ImWchar *title, const char *label, ImGuiWindow *window = nullptr);
	IMGUI_API void			SetInputTextPlaceholder(const ImWchar *placeholder, ImGuiID id);
	IMGUI_API void			SetInputTextPlaceholder(const ImWchar *placeholder, const char *label, ImGuiWindow *window = nullptr);
	// Get Title or Plcaeholder string for Dialog
	IMGUI_API const ImWchar *GetInputTextTitle(ImGuiID id);
	IMGUI_API const ImWchar *GetInputTextTitle(const char *label, ImGuiWindow *window = nullptr);
	IMGUI_API const ImWchar *GetInputTextPlaceholder(ImGuiID id);
	IMGUI_API const ImWchar *GetInputTextPlaceholder(const char *label, ImGuiWindow *window = nullptr);
    ...
    // SIE customization
    IMGUI_API void          SetEnableDepth(bool enabled);
} // namespace ImGui
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_JapaneseForced      = 1 << 19,  // Force the specified languages to be available
    // [Internal]
...
enum ImGuiCol_
{
    ...
    ImGuiCol_WindowBgActive,        //added: Focused window bg color
    ImGuiCol_COUNT
...
struct ImDrawList
{
	...
	float					_Depth;				// [Internal] current depth for 2D drawings
	...
	// Customized:
	//	- Set depth value for drawing ImGui-Objects.
	IMGUI_API void	SetDepth(float depth);
	IMGUI_API void	ResetDepth() { SetDepth(0.0f); }
};
