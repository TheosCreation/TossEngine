...
void ImGui::StyleColorsDark(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.24f, 0.52f, 0.88f, 0.70f); //old ImVec4(0.24f, 0.52f, 0.88f, 1.00f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.13f, 0.20f, 1.00f, 1.00f); //old ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
    ...
    //added: Focused window bg color
    colors[ImGuiCol_WindowBgActive].x = colors[ImGuiCol_WindowBg].x;
    colors[ImGuiCol_WindowBgActive].y = ImMin(colors[ImGuiCol_WindowBg].y + 0.02f, 1.0f);
    colors[ImGuiCol_WindowBgActive].z = ImMin(colors[ImGuiCol_WindowBg].z + 0.04f, 1.0f);
    colors[ImGuiCol_WindowBgActive].w = colors[ImGuiCol_WindowBg].w;
}
...
void ImGui::StyleColorsClassic(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_TitleBg]                = ImVec4(0.18f, 0.18f, 0.27f, 0.83f); //changed: old ImVec4(0.27f, 0.27f, 0.54f, 0.83f);
    colors[ImGuiCol_TitleBgActive]          = ImVec4(0.27f, 0.27f, 0.80f, 0.87f); //changed: old ImVec4(0.32f, 0.32f, 0.63f, 0.87f);
    ...
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.25f, 0.10f, 0.40f, 0.60f); //old ImVec4(0.41f, 0.39f, 0.80f, 0.60f);
    ...
    colors[ImGuiCol_DragDropTarget]         = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
    colors[ImGuiCol_NavHighlight]           = ImVec4(1.00f, 0.00f, 0.50f, 0.90f); //old colors[ImGuiCol_HeaderHovered];
    colors[ImGuiCol_NavWindowingHighlight]  = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
    colors[ImGuiCol_NavWindowingDimBg]      = ImVec4(0.80f, 0.80f, 0.80f, 0.20f);
    colors[ImGuiCol_ModalWindowDimBg]       = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);

    //added: Focused window bg color
    colors[ImGuiCol_WindowBgActive].x = ImMin(colors[ImGuiCol_WindowBg].x + 0.025f, 1.0f);
    colors[ImGuiCol_WindowBgActive].y = ImMin(colors[ImGuiCol_WindowBg].y + 0.025f, 1.0f);
    colors[ImGuiCol_WindowBgActive].z = ImMin(colors[ImGuiCol_WindowBg].z + 0.05f, 1.0f);
    colors[ImGuiCol_WindowBgActive].w = colors[ImGuiCol_WindowBg].w;
}
...
void ImGui::StyleColorsLight(ImGuiStyle* dst)
{
    ...
    colors[ImGuiCol_TextDisabled]           = ImVec4(0.35f, 0.35f, 0.35f, 1.00f); //changed: old ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
    colors[ImGuiCol_WindowBg]               = ImVec4(0.50f, 0.50f, 0.50f, 0.74f); //changed: old ImVec4(0.94f, 0.94f, 0.94f, 1.00f);
    colors[ImGuiCol_ChildBg]                = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    ...
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.26f, 0.59f, 0.98f, 0.67f);
    colors[ImGuiCol_TitleBg]                = ImVec4(0.60f, 0.60f, 0.60f, 1.00f); //changed: old ImVec4(0.96f, 0.96f, 0.96f, 1.00f);
    colors[ImGuiCol_TitleBgActive]          = ImVec4(0.90f, 0.90f, 0.80f, 1.00f); //changed: old ImVec4(0.82f, 0.82f, 0.82f, 1.00f);
    ...
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.20f, 0.20f, 1.00f, 0.60f); //old ImVec4(0.46f, 0.54f, 0.80f, 0.60f);
    colors[ImGuiCol_Button]                 = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.06f, 0.53f, 0.98f, 1.00f);
    colors[ImGuiCol_Header]                 = ImVec4(0.26f, 0.59f, 0.98f, 0.31f);
    ...
    colors[ImGuiCol_NavHighlight]           = ImVec4(0.00f, 0.00f, 1.00f, 1.00f); //old colors[ImGuiCol_HeaderHovered];
    colors[ImGuiCol_NavWindowingHighlight]  = ImVec4(0.70f, 0.70f, 0.70f, 0.70f);
    colors[ImGuiCol_NavWindowingDimBg]      = ImVec4(0.20f, 0.20f, 0.20f, 0.20f);
    colors[ImGuiCol_ModalWindowDimBg]       = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);

    //added: Focused window bg color
    colors[ImGuiCol_WindowBgActive].x = ImMin(colors[ImGuiCol_WindowBg].x + 0.25f, 1.0f);
    colors[ImGuiCol_WindowBgActive].y = ImMin(colors[ImGuiCol_WindowBg].y + 0.25f, 1.0f);
    colors[ImGuiCol_WindowBgActive].z = ImMin(colors[ImGuiCol_WindowBg].z + 0.20f, 1.0f);
    colors[ImGuiCol_WindowBgActive].w = 0.94f;
}
...
void ImDrawList::SetDepth(float depth)
{
    _Depth = GImGui->EnableDepth ? depth : 0.0f;
}
...
void ImDrawList::PrimRect(const ImVec2& a, const ImVec2& c, ImU32 col)
{
    ...
    _VtxWritePtr[0].depth = _Depth;
    _VtxWritePtr[1].depth = _Depth;
    _VtxWritePtr[2].depth = _Depth;
    _VtxWritePtr[3].depth = _Depth;
    _VtxWritePtr += 4;
    _VtxCurrentIdx += 4;
    _IdxWritePtr += 6;
}
...
{
    if (GImGui->EnableDepth) {
        // Draw even if alpha = 0, to equal to Old SpriteRenderer::drawString/drawDebugString
    }
    else {
        if ((col & IM_COL32_A_MASK) == 0)
            return;
...
ImFont* ImFontAtlas::AddFontDefault(const ImFontConfig* font_cfg_template)
{
    ...
    if (font_cfg.Name[0] == '\0') strncpy(font_cfg.Name, "ProggyClean.ttf, 13px", 40);
...
const ImFontGlyph* ImFont::FindGlyph(ImWchar c) const
{
	...
	if (i == (ImWchar)-1) {
#ifdef __PROSPERO__
        // cf: imgui_libfont_prospero.cpp
        extern void reserveNewCode(ImWchar c);
        reserveNewCode(c);	        // Reseve to add glyph and rebuild atlas at next frame.
        return &Glyphs.Data[0];     // Put ' ' (space) until finish rebuild atlas.
#else
        return FallbackGlyph;
#endif
	}
            ...
            if (c != ' ' && c != '\t')
            {
                ...
                if (x1 <= clip_rect.z && x2 >= clip_rect.x)
                {
                    ...
                    // We are NOT calling PrimRectUV() here because non-inlined causes too much overhead in a debug builds. Inlined here:
                    {
                        ...
                        vtx_write[0].depth = draw_list->_Depth;
                        vtx_write[1].depth = draw_list->_Depth;
                        vtx_write[2].depth = draw_list->_Depth;
                        vtx_write[3].depth = draw_list->_Depth;
                        vtx_write += 4;
                        vtx_current_idx += 4;
                        idx_write += 6;
                    }
