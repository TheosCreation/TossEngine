...
int sce::SampleUtil::Input::OskContext::start(const OskParam *param)
{
	...
	m_resultBuffer = new wchar_t[oskParam.m_maxTextLength];
	m_resultBuffer[0] = 0;
	m_resultBufferSize = oskParam.m_maxTextLength;
...
int sce::SampleUtil::Input::OskContext::start(const wchar_t *dialogTitle, const wchar_t *placeholderText, uint32_t maxTextLength)
{
	...
	m_resultBuffer = new wchar_t[maxTextLength + 1];
	m_resultBuffer[0] = 0;
	m_resultBufferSize = maxTextLength + 1;
