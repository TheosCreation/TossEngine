...
#ifndef _SCE_PFX_INTERSECT_MOVING_CIRCLE_ALL_FACETS_H
#define _SCE_PFX_INTERSECT_MOVING_CIRCLE_ALL_FACETS_H
...
#endif // _SCE_PFX_INTERSECT_MOVING_CIRCLE_ALL_FACETS_H
